...
namespace LoanShark.EF.Repository.SocialRepository
{
    ...
    public interface IRepository
    {
        ...
        Task<int> AddChat(string chatName);
        Task AddFriend(int userId, int friendId);
        Task AddImageMessage(int userId, int chatId, string imageURL);
        Task AddNotification(string content, int userId);
        Task AddReport(int messageId, string reason, string description, string status);
        Task AddRequestMessage(int userId, int chatId, string content, string? status = null, float? amount = null, string? currency = null);
        Task AddTextMessage(int userId, int chatId, string content);
        Task AddTransferMessage(int userId, int chatId, string content, string? status = null, float? amount = null, string? currency = null);
        ...
        Task<List<User>> GetChatParticipants(int chatId);
        Task<List<int>> GetChatParticipantsIDs(int chatId);
        Task<List<int>> GetChatsIDs(int userId);
        Task<List<Chat>> GetChatsList();
        Task<List<Post>> GetFeedPostsList();
        ...
        Task<List<Report>> GetReportsList();
