    ...
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<User?> GetUserById(int userId)
        {
            try
            {
                ...
                return new User(0, new Cnp("3440529135984"), "AntoPop", "Anto", "Pop", new Email("test@gddw.ro"), new PhoneNumber("0751413202"), new HashedPassword("trdwdwjlLkndlkwa@272ndwk"));
