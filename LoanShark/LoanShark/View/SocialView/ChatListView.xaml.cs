...
namespace LoanShark.View.SocialView
{
    ...
    public sealed partial class ChatListView : Page
    {
        ...
        public ChatListView(Window mainFrame, IChatServiceProxy chatService, ISocialUserServiceProxy userService, IReportServiceProxy reportService, IMessageServiceProxy messageService, Frame rightFrame, IRepository repository)
        {
        ...
        private void ChatList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                this.RightFrame.Content = new ChatMessagesView(this.chatListViewModel, this.MainFrame, this.RightFrame, selectedChat.getChatID(), this.UserService, this.ChatService, this.MessageService, this.ReportService, this.repository);
            }
        }
    }
}
